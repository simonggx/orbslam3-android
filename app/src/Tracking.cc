...
void Tracking::Track()
{
    ...
    if(mState==NOT_INITIALIZED)
    {
        ...
        {
//            IMU::Calib mImuCalibTest = mCurrentFrame.mImuCalib;
...
void Tracking::MonocularInitialization()
{
    ...
    {
        // Set Reference Frame
        int tmp = mCurrentFrame.mvKeys.size();
        if(mCurrentFrame.mvKeys.size()>100)
        {
//            mInitialFrame = Frame(mImGray,0,mpIniORBextractor,mpORBVocabulary,mpCamera,mDistCoef,mbf,mThDepth);
//            mLastFrame = Frame(mImGray,0,mpIniORBextractor,mpORBVocabulary,mpCamera,mDistCoef,mbf,mThDepth);
